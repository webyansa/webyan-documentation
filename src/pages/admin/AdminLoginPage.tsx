...
import { Loader2, Mail, Lock, User, ArrowRight, Home, Shield, Building2, Headphones } from 'lucide-react';
import { z } from 'zod';
...
export default function AdminLoginPage() {
  ...
  const { user, loading, signIn, signUp, isAdminOrEditor } = useAuth();
  ...
  useEffect(() => {
    if (user && !loading && isAdminOrEditor) {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setSuccess('تم إنشاء الحساب بنجاح! يرجى التواصل مع المسؤول لتفعيل صلاحياتك.');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-50/50 to-background flex flex-col" dir="rtl">
      {/* Header */}
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-md shadow-xl border-red-200/50">
                ...
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <Alert className="mt-4">
                    <AlertDescription className="text-sm">
                      ملاحظة: بعد إنشاء الحساب، ستحتاج إلى التواصل مع المسؤول لتفعيل صلاحيات الإدارة.
                    </AlertDescription>
                  </Alert>
                </form>
              </TabsContent>
